...
// Web3 Functions
let getBalanceInWei = (address) => {
    web3.eth.getBalance(address, (err, bal) => { balance = bal})
        .then(console.log)
}

let transformBalanceFromWeiToUnit = (balance, unit) => {
...
// Sample Test Data
let addr = '0x84b9955d1E6955eCD2EB7e3b513066A52C332f47';
let balance = '4042260583454457';
let unit = 'lovelace';
